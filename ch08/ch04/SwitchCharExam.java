...
public class SwitchCharExam {
	...
	public static void main(String[] args) {
		// switch믄은 동둥비교연산자로 문자(char)도 동등비교할 수 있다.
		...
		char gradeChaStr = inChar.next().charAt(0); //문자열로 받을 값을 문자 처리함.
		...
		case 'b':
		case'B':
			System.out.println("일반회원 회원입니다.");
		    break;
		 
		case 'c':
		case'C':
			System.out.println("사업자회원 회원입니다.");
		    break;
		...
		default:
			...
			if(newMember.equalsIgnoreCase("Yes")) {
				...
				System.out.println("단, 두 번 다시 못 뵐수도 있습니다.");
				break;
			} //회원가입 if문 종료 
