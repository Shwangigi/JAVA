...
public class BoxExam {
	...
	public static void main(String[] args) {
		...
		// 자동 타입 변환후에 사용하려면 강제타입으로 변환하여 활용한다.
		// 예외 System.out.println( int | String | double )는 자동으로 강제타입 변환코드가 들어있음
		...
		Integer val = (Integer) boxI.getObject(); // 강제 타입변환
	
		Box boxA = new Box();
		boxA.setObject(new AppleDTO()); // 자동 타입변환
		// Box boxA = new AppleDTO(); // 다형성
		AppleDTO appleDTO = (AppleDTO) box.getObject(); // 강제 타입변환
	}
}
